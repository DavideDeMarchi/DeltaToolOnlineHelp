...
The **Delta Tool legacy format** is described in detail in the `Forecasting inputs section <fmf_eval/TECH_SPEC.html#inputs>`_.
...
.. figure:: graphics/DatasetForecastLoad.png

   Loading of a forecast dataset
...
.. figure:: graphics/DatasetForecastDisplay.png
...
.. figure:: graphics/forecast_toolbar.png
...
^^^^^^^^^^^^^^^^^
   ...
   | Icon                                             | Function              |
   +==================================================+=======================+
   | .. image:: graphics/forecast_dataset_load.png    | Load a dataset        |
   +--------------------------------------------------+-----------------------+
   | .. image:: graphics/forecast_dataset_remove.png  | Remove your dataset   |
   +--------------------------------------------------+-----------------------+
...
^^^^^^^^^^^^^^^^^^^^
   ...
   | Icon                                                | Function                      |
   +=====================================================+===============================+
   | .. image:: graphics/forecast_experiment_create.png  | Create a new experiment       |
   +-----------------------------------------------------+-------------------------------+
   | .. image:: graphics/forecast_experiment_remove.png  | Remove current experiment     |
   +-----------------------------------------------------+-------------------------------+
   | .. image:: graphics/forecast_experiment_all.png     | Remove all your experiments   |
   +-----------------------------------------------------+-------------------------------+
   | .. image:: graphics/forecast_experiment_select.png  | Select the current experiment |
   +-----------------------------------------------------+-------------------------------+
...
^^^^^^^^^^^^^^^^^
   ...
   | Icon                                                 | Function                                            |
   +======================================================+=====================================================+
   | .. image:: graphics/forecast_display_dataset.png     | Display summary info on the current dataset         |
   +------------------------------------------------------+-----------------------------------------------------+
   | .. image:: graphics/forecast_display_experiment.png  | Display numerical outputs of the current experiment |
   +------------------------------------------------------+-----------------------------------------------------+
   | .. image:: graphics/forecast_display_charts.png      | Display plot outputs of the current experiment      |
   +------------------------------------------------------+-----------------------------------------------------+
   | .. image:: graphics/forecast_display_map.png         | Display stations map of the current experiment      |
   +------------------------------------------------------+-----------------------------------------------------+
   | .. image:: graphics/forecast_display_compare.png     | Compare current experiment with a second one        |
   +------------------------------------------------------+-----------------------------------------------------+
   | .. image:: graphics/forecast_select_horizon.png      | Select one of the available forecasting horizons    |
   +------------------------------------------------------+-----------------------------------------------------+
